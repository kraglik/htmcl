...
class CLContext:
    ...
    def __init__(self, platform=None, device=None, interactive=True, debug=False):
        ...
        self.prg_text += read_kernels(['kernels', 'utils'], self.KERNELS)
        self.prg_text += read_kernels(['kernels', 'htm'], self.HTM_KERNELS)
        self.prg_text += read_kernels(['kernels', 'utils'], self.MAIN_KERNELS)
    ...
    def prepare_heap(self, heap_size_mbytes) -> cl.Buffer:
    ...
    def create_random_seed_buffer(self, n_seeds) -> cl.Buffer:
